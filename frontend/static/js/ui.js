// Donglyn shared UI: loading screen + language toggle + mobile menu
(function () {
  const LANG_DATA = {
    id: {
      ...
      footer_copy: "© 2026 Donglyn • Dibuat oleh Vexalyn Developer [Vio Atmajaya]"
    },
    en: {
      ...
      menu_lang: "Language",
      footer_crafted: "CRAFTED BY",
      footer_copy: "© 2026 Donglyn • Made by Vexalyn Developer [Vio Atmajaya]"
    },
    ja: {
      ...
      menu_lang: "言語",
      footer_crafted: "制作者",
      footer_copy: "© 2026 Donglyn • Vexalyn Developer [Vio Atmajaya] が制作"
    },
    zh: {
      ...
      menu_lang: "语言",
      footer_crafted: "制作者",
      footer_copy: "© 2026 Donglyn • 由 Vexalyn Developer [Vio Atmajaya] 制作"
    }
  };

  let currentLang = localStorage.getItem('donglyn_lang') || 'id';
  ...
  window.setLang = function (lang) {
    currentLang = lang;
    try { localStorage.setItem('donglyn_lang', lang); } catch (e) {}
    applyLang();
    updateLangBtns();
  };
