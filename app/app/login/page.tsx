    ...
    <div className="min-h-[calc(100vh-72px)] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/50 text-sm mt-1">Streaming donghua favoritmu</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-[#0d0d0d] border border-white/10 rounded-2xl p-6 space-y-4">
          ...
          <div className="flex items-center justify-between text-sm">
            <Link href="/forgot-password" className="text-white/50 hover:text-white transition">
              Lupa password?
            </Link>
          </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-2 bg-[#0d0d0d] text-white/40">ATAU</span>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 rounded-xl bg-white/5 border border-white/10 text-white font-medium text-sm hover:bg-white/10 transition-all"
          >
        ...
        <p className="text-center text-sm text-white/50 mt-6">
          Belum punya akun?{" "}
          <Link href="/register" className="text-donglyn hover:underline font-medium">
            Daftar sekarang
          </Link>
        </p>
      </div>
